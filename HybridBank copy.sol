...
contract HybridBank is Ownable {
    ...
    struct Account {
        ...
        uint256 borrowAccruedInterestUntilLastUpdate;
        uint256 lastUpdated;
    }
    ...
    function invest(uint256 _amount) public returns (uint256, uint256) {
        ...
        return (
            ...
            adaiToken.balanceOf(msg.sender)
        );
    }
    ...
    function getInvestmentThreshold() public view returns (uint256) {
        return accounts[msg.sender].investmentThreshold;
    }
